...
const funcoes = {
    ObservacaoClassificada: (observacao) => {
        ...
        axios.post('http://172.27.240.1:10000/eventos', {
...
//172.27.240.1:5000/lembretes/123456/observacoes
app.post('/lembretes/:id/observacoes', async (req, res) => {
    ...
    await axios.post('http://172.27.240.1:10000/eventos', {
...
//172.27.240.1:5000/lembretes/abcd/observacoes
